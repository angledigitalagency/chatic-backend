...
# The new content with rounded borders
...
# Using the line numbers from the previous `view_file` which were 350 to 452
lines[349:452] = [new_templates + '\n']

with open(file_path, 'w', encoding='utf-8') as f:
    f.writelines(lines)

print("Safely updated content_manager.py with rounded frames")
